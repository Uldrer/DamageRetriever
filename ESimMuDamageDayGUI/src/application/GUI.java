...
public class GUI {
	...
	private final double PROGRAM_VERSION = 0.6;
	...
	private final String[] COMBO_WEIGHTS = { "Advantage round threshold","Waste round threshold", "Overkill round threshold", "Tight round weight", "Advantage round weight","Waste round weight", "Overkill round weight", "T2 weight", "T3 weight", "T5 weight", "T10 weight", "T30 weight" , "T120 weight" };
	...
	protected void createContents() {
		...
		lblMemberEnemyDmg.setBounds(MEMBER_START_Y + 2*DMG_LIST_WIDTH + MEMBER_LIST_WIDTH, 72 + TEXT_HEIGHT_SEPARATION, DMG_LIST_WIDTH +20, 15);
